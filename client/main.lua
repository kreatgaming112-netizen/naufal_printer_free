...
RegisterNetEvent('naufal_printer:notification')
AddEventHandler('naufal_printer:notification', function(message, type)
...
RegisterNetEvent("naufal_printer:showImageQB")
AddEventHandler("naufal_printer:showImageQB", function(imageName)
    TriggerServerEvent('naufal_printer:fetchImageLink',imageName)
end)

RegisterNetEvent("naufal_printer:showImage")
AddEventHandler("naufal_printer:showImage", function(imageName)
...
RegisterNetEvent("naufal_printer:openprinter")
AddEventHandler("naufal_printer:openprinter", function()
    ...
    if input then
        if input[1] and input[2] then
            TriggerServerEvent('naufal_printer:insertImageData', input[1], input[2])
        else
            ...
            options = {
                {
                    ...
                    action = function(data)
                        TriggerEvent('naufal_printer:openprinter')
                    end,
                },
            },
            distance = 2
